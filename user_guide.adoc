...
| C_SE_NA_1(136) | Set Multipoint command, normalized value (-1.0 ... +1.0)| + | +
| C_SE_NB_1(137) | Set Multipoint command, scaled value (-32768 ... +32767) | + | +
| C_SE_NC_1(138) | Set Multipoint command, short value (FLOAT32)| + | +
