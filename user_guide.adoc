...
| C_SE_NE_1(136) | Set Multipoint command, normalized value (-1.0 ... +1.0)| + | +
| C_SE_NF_1(137) | Set Multipoint command, scaled value (-32768 ... +32767) | + | +
| C_SE_NG_1(138) | Set Multipoint command, short value (FLOAT32)| + | +
