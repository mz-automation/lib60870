...
create ASDUs that comply to the standards. These special functions are explained in the following sections. They exist generally in two variants for CS101 and CS104.
...
For receiving application layer messages
